...
import ca.germuth.puzzled.fragments.PuzzleStatsFragment;
...
public class StatisticActivity extends PuzzledFragmentActivity implements OnResetListener {
	...
	private PuzzleStatsFragment mPuzzleFragment;
	...
	public void onCreate(Bundle bundle) {
		...
		mPuzzleFragment = PuzzleStatsFragment.newInstance(mSolve.getPuzzle());
