...
public class Pentagon extends Shape {
	...
	//pentagon is made of 3 triangles
	//each triangle must be drawn counterclockwise
	//if pentagon looks like this
	//         
	//          4
	//         /\
	//     0  /  \  3
	...
	//         --
	//       1    2
	//So 0-1-4 makes left, 4-1-2 makes middle, and 4-2-3 makes right triangle
	private final short drawOrder[] = {0, 1, 4, 
										4, 1, 2, 
										4, 2, 3};

	/**
	 * Top Left, Bottom Left, Bottom Right, Top Right, Top
	 * 
	 ...
	 * @param four
	 */
	public Pentagon(GLVertex one, GLVertex two, GLVertex three, GLVertex four,
			GLVertex five) {
	...
	public void finalizeShape() {
		...
		float[] pentagonCoords = getCoords();
	...
	/**
	 * Draw the species shape. Takes in the Model View Projection matrix. Shape
	 * defines list of coordinates, which are modified by above matrix to
	 * account for different screen sizes (projection) and a camera position
	 * (view)
	 */
