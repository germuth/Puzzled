...
public class LeaderboardItemAdapter extends BaseAdapter{
	...
	public LeaderboardItemAdapter(Context c, ArrayList<SolveDB> SolveDBs){
		this.mContext = c;
		this.mSolves = SolveDBs;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(row == null){
			...
			SolveDB item = this.mSolves.get(position);
			...
			duration.setText(Utils.solveDateToString(item.getDuration()));
			
			TextView dateSolveDBd = (TextView) row.findViewById(R.id.leaderboard_list_item_date_solved);
			dateSolveDBd.setText(Utils.solveDateToString(item.getDateSolved()));
